  ...
  return (
    <main id="main" className="shell sign-in-page">
      ...
      <section className="sign-in-panel">
        {configured ? (
          <>
            <p className="eyebrow">{en.brand}</p>
            <h1>{en.login.title}</h1>
            <p className="muted">{en.login.description}</p>
            <SignInForm />
          </>
        ) : (
          <>
            <p className="eyebrow">{en.brand}</p>
            <h1>{en.login.setupTitle}</h1>
            <p className="muted setup-copy">{en.login.setupBody}</p>
            <p className="setup-hint">{en.login.setupHint}</p>
          </>
        )}
      </section>
    </main>
